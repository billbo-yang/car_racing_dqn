...
from gym_car_racing_v1.envs.car_dynamics import Car
...
TRACK_RAD = 4000/ SCALE  # 1400 FOR AB AND 4000 FOR NASCAR
PLAYFIELD = 10000 / SCALE  # Game over boundary
FPS = 50  # Frames per second, normally 50
ZOOM = 0.05# Camera zoom
ZOOM_FOLLOW = True  # Set to False for fixed view (don't use zoom)


TRACK_DETAIL_STEP = 40 / SCALE
TRACK_TURN_RATE = .6 # 0.3 WORKS FOR Bahrain TRACK # 0.6 WORKS FOR NASCAR
...
class CarRacing(gym.Env, EzPickle):
    ...
    def _create_track(self):
        ...
        checkpoints = [(0, 310, 0), (1.0303768265243125, 299.99999999999994, 500.0), (1.4056476493802699, 75, 598.0), (1.5707963267948966, 3.6739403974420595e-14, 595.0), (1.7359450042095235, -75.0, 587.0), (2.0940746489268722, -300.00000000000006, 500.0), (3.141592653589793, -310.0, 3.9188697572715304e-14), (4.171969480114106, -300.0, -500.0), (4.547240302970063, -75, -598.0), (4.71238898038469, -1.1021821192326178e-13, -595.0), (4.877537657799317, 75, -587.0), (5.235667302516665, 300.0, -500.0)]
